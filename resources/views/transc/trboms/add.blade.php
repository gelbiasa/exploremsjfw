                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-control-label">Jumbo</label>
                                            <input type="text" class="form-control jumbo" name="bom_data[{{ $i }}][jumbo]" id="jumbo-{{ $i }}" placeholder="Input Jumbo...">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-control-label">Rewind</label>
                                            <input type="text" class="form-control rewind" name="bom_data[{{ $i }}][rewind]" id="rewind-{{ $i }}" placeholder="Input Rewind...">
                                        </div>
                                    </div>
                                </div>
